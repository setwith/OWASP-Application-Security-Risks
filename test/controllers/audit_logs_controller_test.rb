...
class AuditLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create audit_log" do
    assert_difference("AuditLog.count") do
      post audit_logs_url, params: { audit_log: { activity: @audit_log.activity, ip_address: @audit_log.ip_address, user_id: @audit_log.user_id } }
    end
  ...
  test "should update audit_log" do
    patch audit_log_url(@audit_log), params: { audit_log: { activity: @audit_log.activity, ip_address: @audit_log.ip_address, user_id: @audit_log.user_id } }
